...
default(linewidth = 3.0, dpi = 200, size = (1000, 400), legend = :outertopright, bottom_margin = 12px, left_margin = 16px, framestyle=:box, legendfontsize=10)

plt = plot(xlabel = "Time (s)", ylabel = "Concentration (uM)")
plotfig1!(plt,osol;tend=length(osol))

savefig("OscillatorPaper/lipid_timeseries.png")
