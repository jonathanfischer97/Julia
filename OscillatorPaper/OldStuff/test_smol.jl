...
scatter(t, jsol(t)[1,:]/uₒ, label="X1 (monomers)", markercolor=:blue)
scatter!(t, jsol(t)[2,:]/uₒ, label="X2 (dimers)", markercolor=:orange)
scatter!(t, jsol(t)[3,:]/uₒ, label="X3 (trimers)", markercolor=:purple)